            ...
            <form onSubmit={create} className={`absolute top-16 right-3 gap-3 bg-[#252627] w-[250px] p-4 text-white ${show ? 'visible opacity-100' : 'invisible opacity-50'} transition-all duration-500`}>
                ...
                <div className='grid grid-cols-2 pb-4 gap-3'>
                    <div className='flex gap-2 justify-center items-start flex-col'>
                        ...
                        <input onChange={inputHandle} required type="number" name="width" id="width" className='w-full outline-none px-2 py-1 bg-[#1b1a1a] border border-[#404040] rounded-md'/>
                    </div>
                    <div className='flex gap-2 justify-center items-start flex-col'>
                        <label htmlFor="height">Height</label>
                        <input onChange={inputHandle} required type="number" name="height" id="height"  className='w-full outline-none px-2 py-1 bg-[#1b1a1a] border border-[#404040] rounded-md'/>
                    </div>
                </div>
