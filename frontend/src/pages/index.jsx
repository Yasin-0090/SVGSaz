...
const index = () => {
  ...
  return (  
    <div className="bg-[#18191b] min-h-screen w-full">
      ...
      <div className=" bg-[#252627ad] shadow-md">
          ...
          <div className="flex justify-between items-center ">
            ...
            <div className="flex gap-4">
                <button onClick={()=>{
                  setType('signin')
                  setShow(true)
                }} className="py-2 w-20 text-center bg-blue-500 text-white transition-all hover:bg-blue-600 rounded-[5px] font-medium">Sign In</button>
                <button onClick={()=>{
                  setType('signup')
                  setShow(true)
                }} className="py-2 w-20 text-center bg-purple-500 text-white transition-all hover:bg-purple-600 rounded-[5px] font-medium">Sign Up </button>
            </div>    
          </div>
        </div>
      </div>
      <div className="w-full h-full justify-center items-center p-4 ">
        <div className="py-[168px] flex justify-center items-center flex-col gap-6 ">
            <h2 className="text-5xl text-[#c7c5c5] font-bold">Ready to create something awesome?</h2>
            <span className="text-[#aca9a9] text-2xl font-medium">Here you can Design freely and Download Svg easily</span>
            <button onClick={()=>{
              setType('signup')
              setShow(true)
              }} className="py-2 w-[200px] text-center bg-purple-500 text-white transition-all hover:bg-purple-600 rounded-[5px] font-medium">Signup for free
            </button>
        </div>
      </div>
    </div>
